  ...
  return (
    <group position={SCENE.condenser}>
      ...
      <mesh position={[0, 0.04, 0]} receiveShadow>
        <boxGeometry args={[3.35, 0.08, 3.35]} />
        <meshStandardMaterial color="#52525b" roughness={0.98} />
      </mesh>
      <mesh position={[0, 0.1, 0]} receiveShadow>
        <boxGeometry args={[3.05, 0.06, 3.05]} />
        <meshStandardMaterial color={PALETTE.condenserPad} roughness={0.96} />
      </mesh>
      <mesh position={[0, 0.14, 0]} receiveShadow>
        <boxGeometry args={[2.85, 0.04, 2.85]} />
        <meshStandardMaterial color="#71717a" roughness={0.94} />
      </mesh>

      <mesh position={[0, 0.72, 0]} castShadow receiveShadow>
        <boxGeometry args={[2.2, 1.35, 2.2]} />
        <meshStandardMaterial color={PALETTE.condenserBody} roughness={0.68} metalness={0.22} />
      </mesh>
